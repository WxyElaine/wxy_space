...
export const Publications = [
    ...
    (<ol>
        <li>
            <b>Xinyi Wang</b>, Kavita Krishnaswamy, Maria E. Cabrera, and Maya Cakmak. 2020. <a href="https://dl.acm.org/doi/10.1145/3371382.3378387">"Robotic Limb Repositioning with Supervised Autonomy"</a>. In Companion of the 2020 ACM/IEEE International Conference on Human-Robot Interaction (HRI ’20). Association for Computing Machinery, New York, NY, USA, 511–513.
        </li>
        <li>
            Maria E. Cabrera, Maya Cakmak, Podshara Chanrungmaneekul, Brian J. Lee, Eric Pan, Vinitha Ranganeni, Nick Walker, <b>Xinyi Wang</b>. "Dawgs@Home: RoboCup 2020 Open Platform League Team Description Paper".
        </li>
    </ol>)
];
...
export const Awards = [
    <h5>Awards</h5>,
    <p>2020 <b>Outstanding Undergraduate Researcher Award Honorable Mention, Computing Research Association</b></p>,
